    ...
    <div className="about-page">
      ...
      <div className="officer-section">
        <div className="officer-card">
          <img src="https://cdn.indigomagazinetx.com/about/officer%20pics/manjiri.jpg" alt="Manjiri" />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/sanhita.jpg"
            alt="Sanhita"
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/lauren.png"
            alt="Lauren Lowndes"
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/sreya.jpg"
            alt="Sreya I."
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/nicole.jpg"
            alt="Nicole C."
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/alaynna.jpg"
            alt="Alaynna"
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/dhiraj.jpg"
            alt="Dhiraj"
          />
          <h2>
        ...
        <div className="officer-card">
          <img
            src="https://cdn.indigomagazinetx.com/about/officer%20pics/jeslin.jpg"
            alt="Jeslin"
          />
          <h2>
        ...
        <div className="officer-card">
          <img src="https://cdn.indigomagazinetx.com/about/officer%20pics/291199FA-AC0E-4C55-ADCA-8CCFA99E5BD6_1_105_c.jpeg" alt="Emma Gonzalez" />
          <h2>
